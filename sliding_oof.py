...
def calc_spectral_psd(data, srate, method_type = "median"):
    ...
    (f, psd) = spectral.compute_spectrum(sig = data, fs = srate, avg_type = method_type, nperseg = srate*2)
    return(f, psd)
...
if __name__ == '__main__':
    ...
    for window_number, start_index in enumerate(start_idx):
        ...
        if VERBOSE:
            ...
            print("window start %d, window end %d" % (start_index, start_index + window_size_samples))
